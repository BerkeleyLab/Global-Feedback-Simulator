...
$(d)/_accelerator.so: $(d)/filter.o $(d)/cavity.o $(d)/rf_station.o $(d)/accelerator_wrap.o
	ld -shared $^ -o $@

export UNIT_TEST_FILES := $(d)/unit_tests_all.py $(d)/cavity_test.py $(d)/rf_station_test.py 
