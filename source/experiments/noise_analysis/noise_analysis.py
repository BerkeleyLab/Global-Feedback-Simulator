...
def run_noise_numerical_tests():
    ...
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json", "source/experiments/noise_analysis/nominal.json"]
    ...
    # Amplitude
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json",
                 "source/experiments/noise_analysis/nominal.json", "source/experiments/noise_analysis/149_noise.json"]
    ...
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json",
                 "source/experiments/noise_analysis/hobicat.json", "source/experiments/noise_analysis/149_noise.json"]
    signal1 = run_noise_numerical(Tmax, test_file, beam_configuration, detuning=False)
    ...
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json",
                 "source/experiments/noise_analysis/high_gain.json", "source/experiments/noise_analysis/149_noise.json"]
    signal1 = run_noise_numerical(Tmax, test_file, beam_configuration, detuning=False)
    ...
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json",
                 "source/experiments/noise_analysis/high_gain.json", "source/experiments/noise_analysis/138_noise.json"]
    signal1 = run_noise_numerical(Tmax, test_file, beam_configuration, detuning=False)
...
if __name__ == "__main__":
    ...
    test_file = ["source/configfiles/unit_tests/LCLS-II_accelerator.json", "source/experiments/noise_analysis/high_gain.json"]
