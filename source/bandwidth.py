...
plt.text(bw[0]*1e-3*1.0,np.log10(npd[0])*10+20,'nominal', verticalalignment='top', horizontalalignment='center', rotation=90, fontsize=50)
plt.text(bw[1]*1e-3*1.0,np.log10(npd[1])*10+21.5,'HoBiCaT', verticalalignment='top', horizontalalignment='center', rotation=90, fontsize=50)
plt.text(bw[2]*1e-3*1.0,np.log10(npd[2])*10+23,'high-gain', verticalalignment='top', horizontalalignment='center', rotation=90, fontsize=50)
