...
TGT_$(d)        := $(d)/user_manuals/sourcecodemap.pdf $(d)/user_manuals/structuraldocumentation.pdf $(d)/user_manuals/errata.pdf $(d)/presentations/lbnl_intro_sept13/linac_modeling_remake.pdf $(d)/presentations/lbnl_intro_sept13/linac_modeling_for_slac.pdf $(d)/publications/LLRF13/paper/system_feedback_models.pdf
...
CLEAN           := $(CLEAN) $(TGT_$(d)) $(d)/user_manuals/*.ps $(d)/diagrams/codeoutline.png $(LATEX_AUX_FILES) $(d)/publications/LLRF13/paper/system_feedback_models.ps
