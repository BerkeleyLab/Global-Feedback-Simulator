...
noise_analysis.log: $(SOURCE_DIR)/_accelerator.so $(SOURCE_DIR)/experiments/noise_analysis/noise_analysis.py
	python $(SOURCE_DIR)/experiments/noise_analysis/noise_analysis.py > $@
